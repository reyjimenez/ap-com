...
$j(function() {
	...
	$j('.woocommerce_page_woo_ce .advanced-settings a.delete, .woocommerce_page_woo_ce .field-editor a.confirm-button, .woocommerce_page_woo_ce #archives-filter a.delete, .post-type-scheduled_export a.confirm-button').click(function(e){
		e.preventDefault();
