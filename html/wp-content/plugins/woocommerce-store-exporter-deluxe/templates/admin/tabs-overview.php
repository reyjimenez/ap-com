...
-->
	...
	<h3><div class="dashicons dashicons-calendar"></div>&nbsp;<a href="<?php echo esc_url( add_query_arg( 'tab', 'scheduled_export' ) ); ?>"><?php _e( 'Scheduled Exports', 'woocommerce-exporter' ); ?></a></h3>
