			...
			<div class="inside">
				...
				<table class="form-table">
					...
					<tr>
						...
						<td>
							<span class="description">(<?php echo $review; ?>)</span>
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							<span class="description">(<?php echo $ticket; ?>)</span>
						</td>
					</tr>
...
<?php if( $product_fields ) { ?>
		<div id="export-product" class="export-types">
			...
			<div class="postbox">
				...
				<div class="inside">
	<?php if( $product ) { ?>
					<p class="description"><?php _e( 'Select the Product fields you would like to export, you can drag-and-drop to reorder export fields and change the label of export fields from the Configure link to the right. Your field selection and supported filters are saved for future exports.', 'woocommerce-exporter' ); ?></p>
					<p>
		...
		<div id="export-brand" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'brand' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
	<?php if( $brand ) { ?>
		...
		<div id="export-customer" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'customer' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
	<?php if( $customer ) { ?>
		...
		<div id="export-review" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'review' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
	<?php if( $review ) { ?>
		...
		<div id="export-coupon" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'coupon' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
	<?php if( $coupon ) { ?>
		...
		<div id="export-subscription" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'subscription' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
	<?php if( $subscription ) { ?>
		...
		<div id="export-product_vendor" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'product_vendor' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
		...
		<div id="export-commission" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'commission' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
	<?php if( $commission ) { ?>
		...
		<div id="export-shipping_class" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'shipping_class' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
		...
		<div id="export-ticket" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'ticket' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
	<?php if( $ticket ) { ?>
		...
		<div id="export-attribute" class="export-types">
			...
			<div class="postbox">
				<h3 class="hndle">
					...
					<a href="<?php echo esc_url( add_query_arg( array( 'tab' => 'fields', 'type' => 'attribute' ) ) ); ?>" style="float:right;"><?php _e( 'Configure', 'woocommerce-exporter' ); ?></a>
				</h3>
				<div class="inside">
	<?php if( $attribute ) { ?>
