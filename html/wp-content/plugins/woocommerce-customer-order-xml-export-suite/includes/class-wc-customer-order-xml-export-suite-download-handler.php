...
class WC_Customer_Order_XML_Export_Suite_Download_Handler {
	...
	public function download_exported_file() {
		 ...
		 */
		$filename = apply_filters( 'wc_customer_order_xml_export_suite_file_download_filename', $filename, $export_id );
		 ...
		 * @param string $export_id
		 */
		$file_download_method = apply_filters( 'wc_customer_order_xml_export_suite_file_download_method', get_option( 'woocommerce_file_download_method', 'force' ), $export_id );
