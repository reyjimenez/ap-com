 ...
 *
 * @package     WC-Customer-Order-XML-Export-Suite/Admin/Views
 * @author      SkyVerge
...
<table class="wc_status_table widefat" cellspacing="0" id="wc-customer-order-xml-export-suite-status">
	...
	<tbody>
		<tr>
			...
			<td class="help"><?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'The selected order export format.', 'woocommerce-customer-order-xml-export-suite' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'The selected customer export format.', 'woocommerce-customer-order-xml-export-suite' ) ); ?></td>
		...
		<tr>
			...
			<td class="help"><?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'The automatic export method if enabled.', 'woocommerce-customer-order-xml-export-suite' ) ); ?></td>
		...
		<?php if ( 'disabled' !== $auto_export_orders ) : ?>
			...
			<tr>
				...
				<td class="help"><?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'The automatic export trigger.', 'woocommerce-customer-order-xml-export-suite' ) ); ?></td>
			...
			<tr>
				...
				<td class="help"><?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'The automatic export start time.', 'woocommerce-customer-order-xml-export-suite' ) ); ?></td>
			...
			<tr>
				...
				<td class="help"><?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'The automatic export start interval in minutes.', 'woocommerce-customer-order-xml-export-suite' ) ); ?></td>
			...
			<tr>
				...
				<td class="help"><?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'The order statuses to be included in the automatic export.', 'woocommerce-customer-order-xml-export-suite' ) ); ?></td>
			...
			<tr>
				...
				<td class="help"><?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'The product categories to be included in the automatic export.', 'woocommerce-customer-order-xml-export-suite' ) ); ?></td>
			...
			<tr>
				...
				<td class="help"><?php echo SV_WC_Plugin_Compatibility::wc_help_tip( __( 'The products to be included in the automatic export.', 'woocommerce-customer-order-xml-export-suite' ) ); ?></td>
