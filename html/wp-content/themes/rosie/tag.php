...
?>
	<div id="sidebar" class="<?php echoesc_attr( $ozy_data->_page_content_css_name); ?>">
		<ul>
			...
			<div class="parallax-wrapper">
            	<div class="vc_col-sm-12 wpb_column vc_column_container">
                	<div class="wpb_wrapper">
                        ...
                        ?>
                        <div class="post-single post-format-<?php echo $post_format ?> ozy-waypoint-animate ozy-appear">
						<?php
                            ...
                            else if( 'video' !== $post_format && 'audio' !== $post_format )
                            {
                                if ( isset($thumbnail_image_src[0]) ) { 
                                    //echo '<div class="featured-thumbnail"><a href="'. $thumbnail_image_src[0] .'" class="fancybox"><span class="oic-simple-line-icons-49"></span></a>'; the_post_thumbnail('blog'); echo '</div>';
