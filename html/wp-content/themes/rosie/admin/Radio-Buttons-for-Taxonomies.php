...
class WordPress_Radio_Taxonomy {
	static $taxonomy = 'portfolio_category';
	static $taxonomy_metabox_id = 'portfolio_categorydiv';
	static $post_type = 'ozy_portfolio';

	public static function load(){
		/*global $ozyHelper;
		if($ozyHelper->ozy_get_current_post_type() !== 'ozy_portfolio') { return false; }*/
	...
	public static function add_meta_box() {  
		add_meta_box( 'mytaxonomy_id', 'Portfolio Categories',array(__CLASS__,'metabox'), self::$post_type ,'side','core');  
	}  
	...
	public static function metabox( $post ) {  
		...
		<div id="taxonomy-<?php echo $taxonomy; ?>" class="categorydiv">
			...
			<ul id="<?php echo $taxonomy; ?>-tabs" class="category-tabs">
				...
				<li class="hide-if-no-js"><a href="#<?php echo $taxonomy; ?>-pop" tabindex="3"><?php _e( 'Most Used', 'vp_textdomain' ); ?></a></li>
			</ul>
	...
	public static function admin_script(){  
		global $ozyHelper;
		if($ozyHelper->ozy_get_current_post_type() === 'ozy_portfolio') {
			wp_register_script( 'radiotax', get_template_directory_uri() . '/scripts/admin/radiotax.js', array('jquery'), null, true ); // We specify true here to tell WordPress this script needs to be loaded in the footer  
